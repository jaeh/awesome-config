...
beautiful.init(conf_dir .. "/themes/kallisti/theme.lua")
...
local batwidget = require("widgets/batwidget")
local volumewidget = require("widgets/volumewidget")
local showhidewidget = require("widgets/showhidewidget")
...
-- separator that can show and hide
...
terminal = "lxterminal"
editor = os.getenv("EDITOR") or "geany" or "vim"
editor_cmd = editor
...
for s = 1, screen.count() do
    ...
    right_layout:add(shspacer)
    right_layout:add(shsep)
    right_layout:add(shspacer)
    ...
    right_layout:add(showhidewidget)
